...
class HomePageAdminWidget extends StatefulWidget {
  const HomePageAdminWidget({
    super.key,
    this.loggedInUserDoc,
  });

  final UsersRecord? loggedInUserDoc;
...
class _HomePageAdminWidgetState extends State<HomePageAdminWidget>
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) => safeSetState(() {
          _model.textController6?.text = 'Team Name ';
        }));
  }
                                                                  ...
                                                                  builder: (context,
                                                                    ...
                                                                    return InkWell(
                                                                      ...
                                                                      onTap:
                                                                          () async {
                                                                        context.pushNamed(
                                                                            AllEmployeeViewWidget.routeName);
                                                                      },
                                                                      child:
                                                                          Container(
                                                                        decoration:
                                                                          ...
                                                                          child:
                                                                            ...
                                                                            child:
                                                                              ...
                                                                              builder: (context, snapshot) {
                                                                                ...
                                                                                final containerClientsRecord = containerClientsRecordList.isNotEmpty ? containerClientsRecordList.first : null;
                                                                                  ...
                                                                                  child: Padding(
                                                                                    ...
                                                                                    child: Column(
                                                                                      ...
                                                                                      children: [
                                                                                        ...
                                                                                        Text(
                                                                                          (containerClientsRecord != null).toString(),
                                                                                          style: FlutterFlowTheme.of(context).bodyMedium.override(
                                                                                                font: GoogleFonts.readexPro(
                                                                      ...
                                                                      builder:
                                                                        ...
                                                                        return Column(
                                                                          ...
                                                                          children: [
                                                                            ...
                                                                            wrapWithModel(
                                                                              model: _model.tooltipactivityModel,
                                                                              updateCallback: () => safeSetState(() {}),
                                                                              child: TooltipactivityWidget(),
                                                                            ),
                                                                          ],
                                                                        );
                                                                      },
...
class HomePageAdminModel extends FlutterFlowModel<HomePageAdminWidget> {
  ...
  DateTime? startofmyday;

  ///  State fields for stateful widgets in this page.

  // Stores action output result for [Backend Call - Read Document] action in HomePageAdmin widget.
  UsersRecord? userdoc;
